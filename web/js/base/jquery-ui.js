...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, droppable.js, resizable.js, accordion.js
...
$.widget("ui.rotatable", $.ui.mouse, {
    ...
    performRotation: function(angle) {
        ...
        var origin_transform = this.element[0].style['-webkit-transform'];

        //弧度转角度
        angle = angle * 180 / Math.PI;

        if(origin_transform.indexOf('rotate') > -1){
	        origin_transform = origin_transform.replace(/rotateZ\(.+?deg\)/g,'rotateZ(' + angle + 'deg)');
	        this.element.css('-webkit-transform',origin_transform);
    ...
    rotateElement: function(event) {
        ...
        this.element.data('elementCurrentAngle',this.elementCurrentAngle);
